...
function CheckAuthentication()
{
	...
	return isset($_SESSION['admin_uname']) && $_SESSION['admin_uname'];
}
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl.'images'.'/'.date("Ym",time()),
		'directory' => $baseDir . 'images' . '/'. date("Ym",time()),
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,swf,flv',
		'deniedExtensions' => '');
