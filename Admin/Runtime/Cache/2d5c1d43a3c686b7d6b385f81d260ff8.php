...
<div id="body-wrapper">
    ...
    <div id="main-content">
    	<p id="page-intro">商户列表>>
        <hr>
        </p>
        <form action="__APP__/Fenlei/hangyeaddsave/" method="post">
            <table border="1" cellpadding="1" cellspacing="0">
                ...
                <?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vocompany): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vocompany["star"]); ?>星</td>
                    <td>已认证</td>
                    <td><?php echo ($vocompany["addtime"]); ?></td>
                    <td><a href="__APP__/shanghu/xuanzhong/id/<?php echo ($vocompany["id"]); ?>">选中</a>&nbsp;<a href="__APP__/shanghu/xufei/id/<?php echo ($vocompany["id"]); ?>">续费</a>&nbsp;<a href="__APP__/shanghu/edit/id/<?php echo ($vocompany["id"]); ?>">修改</a>&nbsp;<a href="__APP__/shanghu/del/id/<?php echo ($vocompany["id"]); ?>">删除</a></td>
