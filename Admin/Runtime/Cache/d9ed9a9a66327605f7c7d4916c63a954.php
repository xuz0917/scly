...
<div id="body-wrapper">
    ...
    <div id="main-content">
    	<p id="page-intro">修改产品>>
<hr>
        </p>
        <form action="__APP__/product/editsave/" method="post">
	        <input type="hidden" name="id" value="<?php echo ($product["id"]); ?>" />
            <table border="1" cellpadding="1" cellspacing="0">
                <tr>
                    <td width="60">产品名：</td><td><input type="text" name="title" class="text-input large-input" value="<?php echo ($product["title"]); ?>" /></td>
                </tr>
                <tr>
                	<td>所属行业：</td>
                	<td>
						...
						<script type="text/javascript">
							document.getElementById("hangye").value=<?php echo ($product["hangye"]); ?>;
						</script>
						<script type="text/javascript">
							document.getElementById("prolist").value=<?php echo ($product["prolist"]); ?>;
						</script>
                    </td>
                </tr>
                <tr>
                    <td width="60">价格：</td><td><input type="text" name="jiage" value="<?php echo ($product["jiage"]); ?>" class="text-input" style="width:50px" />元</td>
                </tr>
                <tr>
                	<td>产品大图：</td>
                	<td>
                    	<input type="text" name="pic1" value="<?php echo ($product["pic1"]); ?>" id="pic1" class="text-input small-input" />  <input type="button" value=" 浏 览 " onClick="BrowseServer('pic1');" class="button" />&nbsp;
                    	<input type="text" name="pic2" value="<?php echo ($product["pic2"]); ?>" id="pic2" class="text-input small-input" />  <input type="button" value=" 浏 览 " onClick="BrowseServer('pic2');" class="button" />&nbsp;
                    	<input type="text" name="pic3" value="<?php echo ($product["pic3"]); ?>" id="pic3" class="text-input small-input" />  <input type="button" value=" 浏 览 " onClick="BrowseServer('pic3');" class="button" />&nbsp;<br><br></td>
                </tr>
                <tr>
                	<td style="vertical-align:middle">产品详情：</td>
                	<td height="200"><textarea name="contents" id="contents"><?php echo ($product["contents"]); ?></textarea>
                    	<script type="text/javascript">
                ...
                <tr>
                	<td>关键词：</td>
                	<td><input type="text" name="keywords" value="<?php echo ($product["keywords"]); ?>" class="text-input large-input" /></td>
                </tr>
                <tr>
                	<td style="vertical-align:top">描述：</td>
                	<td><textarea name="description" style="height:60px"><?php echo ($product["description"]); ?></textarea></td>
                </tr>
                <tr>
                	<td></td>
