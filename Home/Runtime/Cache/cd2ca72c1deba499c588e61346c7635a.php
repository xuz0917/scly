...
<title>荣誉资质-<?php echo ($company["companyname"]); ?></title>
        	...
        	<div class="shiting mb15">
            	...
            	<div class="shiting-m">
                    <div class="shiting-bt">
                    	<div class="title"><span class="color1">荣誉资质</span><span class="color2"> / RONGYU</span></div>
                    </div>
                    <div class="shiting-nr" id="nrtt1"  style="display:">
                          <ul>
                          <?php if($company['rongyu']){ echo "<li><a href='{$company['rongyu']}' target='_blank'>
		                            <img src='{$company['rongyu']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu1']){ echo "<li><a href='{$company['rongyu1']}' target='_blank'>
		                            <img src='{$company['rongyu1']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu2']){ echo "<li><a href='{$company['rongyu2']}' target='_blank'>
		                            <img src='{$company['rongyu2']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu3']){ echo "<li><a href='{$company['rongyu3']}' target='_blank'>
		                            <img src='{$company['rongyu3']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu4']){ echo "<li><a href='{$company['rongyu4']}' target='_blank'>
		                            <img src='{$company['rongyu4']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu5']){ echo "<li><a href='{$company['rongyu5']}' target='_blank'>
		                            <img src='{$company['rongyu5']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu6']){ echo "<li><a href='{$company['rongyu6']}' target='_blank'>
		                            <img src='{$company['rongyu6']}' width='343' height='205'  /></a></li>
		                        "; } if($company['rongyu7']){ echo "<li><a href='{$company['rongyu7']}' target='_blank'>
		                            <img src='{$company['rongyu7']}' width='343' height='205'  /></a></li>
		                        "; } ?>
                          </ul>
