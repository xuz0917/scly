...
<title><?php echo ($company["title"]); ?>-<?php echo ($company["companyname"]); ?></title>
...
<div class="mainbox0">
    <div class="main">
        ...
        <div class="right">
        	<div class="anli mb15">
            	<div class="anli-t"></div>
            	<div class="anli-m">
                    <div class="anli-bt">
                    	<div class="title"><span class="color1">公司简介</span><span class="color2"> / COMPANY</span></div>
                    </div>
                    <div class="anli-nr">
                    	<?php mb_strcut($company['jianjie'],0,500,'UTF-8') ?>
                    </div>
                </div>
            	<div class="anli-b"></div>
            </div>
            
            <div class="zhuying mb15">
            	<div class="zhuying-t"></div>
            	<div class="zhuying-m">
                    <div class="zhuying-bt">
                    	<div class="title"><span class="color1">公司主营</span><span class="color2"> / MAIN</span></div>
                    </div>
                    <div class="zhuying-bt">
                    	<div class="title"><span class="color1">联系方式</span><span class="color2"> / CONTACTS</span></div>
                    </div>
                    <div class="zhuying-nr" style=" border-right:1px dashed #CCC">
                    	<p><?php echo ($company["zhuying"]); ?></p>
                    </div>
                    <div class="zhuying-nr" style="float:right">
                    	<?php echo ($company["lianxi"]); ?>
                    </div>
                </div>
            	<div class="zhuying-b"></div>
            </div>
                    ...
                    <div class="shiting-nr" id="nrtt1"  style="display:">
                          ...
                          <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voproduct): $mod = ($i % 2 );++$i;?><li>
                            	<a href="__APP__/item-<?php echo ($voproduct["id"]); ?>">
                                	<img src="<?php echo ($voproduct["pic1"]); ?>" />
